...
//				if(wordList.get(j).getWord() == prevword) {
//					found = true;
...
//				// add "w" as a nextWord to the "prevWord" node
//				wordList.get(wordList.size()-1).addNextWord(words.get(i));
//			}
//			// initial
...
//				node.addNextWord(words.get(0));
//				break;
//			}
//			else {
//				wordList.add(new ListNode(lastword));
//				wordList.get(wordList.size()-1).addNextWord(words.get(0));
//				break;
//			}
//		}
	}
