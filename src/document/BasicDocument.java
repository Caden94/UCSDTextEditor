...
//		System.out.println("NumWords: "+tokens.size());
	    return tokens.size();
	}
...
//		System.out.println("NumSentences: "+tokens.size());
        return tokens.size();
	}
	...
	public int getNumSyllables()
	{
		...
		int num = 0;
		List<String> wordList = getTokens("[a-zA-Z]+");
		for (String word : wordList) {
			num+=countSyllables(word);
		}
//		System.out.println("NumSyllables: "+num);
        return num;
	}
